                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-header">
                      <h3>Edit Customer
                      <a class="btn btn-primary btn-sm float-right" href="{{route('customers.view')}}"> <i class="fa fa-list">Customer list</i></a>
                      </h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
            <form action="{{ route('customers.update',$editdata->id) }}" method="POST" enctype="multipart/form-data" id="myForm">
                        @csrf
